...
--end
--
--local function wrap(side, name, hl, i, len, c)
--    local l_index = i - len
--    local r_index = i + 1
--    gls[side][l_index] = {
--        [name .. 'Left'] = {
--            condition = c or ret_true,
--            provider = function()
...
--end
--
--local function wrapl(name, hl, i, len, c)
--    wrap('left', name, hl, i, len, c)
--end
--
--local function wrapr(name, hl, i, len, c)
--    wrap('right', name, hl, i, len, c)
--end
--
--local M = {}
--function M.setup()
...
--    }
--
--    wrapl('ViMode', 'GalaxyViMode', i, 1, tight_space)
--
--    -- File --
--    i = i + 3
--
...
--    }
--
--    wrapl('File', 'GalaxyFile', i, 2, medium_space)
--    i = i + 2
--
--    -- LSP --
--    gls.left[i] = {
...
--    }
--
--    wrapr('Git', 'GalaxyGitBranch', i, 1, wide_space)
--    i = i + 3
--
--
--    gls.right[i] = {
...
--        },
--    }
--    wrapr('LineInfo', 'GalaxyLineInfo', i, 1, tight_space)
--
--end
--
--M.setup()
